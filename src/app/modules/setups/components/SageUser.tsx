...
const SgaeUser = () => {
    ...
    const [sageUser, setSageUser] = useState<SageUserModel[]>([]);
        ...
        <Content>
                <div className={`card mb-5 mb-xxl-8`}>
                    <div className='card-body pt-9 pb-0'>
                        ...
                        <Table columns={columns} dataSource={allSageUsers?.data} loading={loadingSU} />
                    </div>
                </div>
        </Content>
        ...
        >
            ...
            >
                <div className="col-12 row mt-10">
                    ...
                    {/*<div className='col-6  mb-3'>*/}
                    {/*    <label className='form-label fs-6 fw-bolder text-gray-600'>Company</label>*/}
                    {/*    <select*/}
                    ...
                    {/*</div>*/}
                    {/*<div className='col-6  mb-3'>*/}
                    {/*    <label className='form-label fs-6 fw-bolder text-gray-600'>isAdmin</label>*/}
                    {/*    <select*/}
                    {/*        {...formik.getFieldProps('isAdmin')}*/}
                    {/*        className={clsx(*/}
                    {/*            'form-select form-select-solid',*/}
                    {/*            {'is-invalid': formik.touched.isAdmin && formik.errors.isAdmin},*/}
                    {/*            {*/}
                    {/*                'is-valid': formik.touched.isAdmin && !formik.errors.isAdmin,*/}
                    {/*            }*/}
                    {/*        )}*/}
                    {/*    >*/}
                    {/*        <option>Select</option>*/}
                    {/*        <option value="no">No</option>*/}
                    {/*        <option value="yae">Yes</option>*/}
                    {/*    </select>*/}
                    {/*    {formik.touched.isAdmin && formik.errors.isAdmin && (*/}
                    {/*        <div className='fv-plugins-message-container'>*/}
                    {/*            <span role='alert'>{formik.errors.isAdmin}</span>*/}
                    {/*        </div>*/}
                    {/*    )}*/}
                    {/*</div>*/}
                </div>
